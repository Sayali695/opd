...
<div style="width: 80%; margin: auto;margin-top: 20px;">
	<div style="border: solid;padding: 10px; border-radius: 5px;">
		...
		<div class="row gx-3 gy-2 align-items-center">
			  ...
			  <div class="col-sm-4">
			    <h5><span>n ame : <?php echo $row['p_name'];?></span></h5>
			  </div>
			  <div class="col-sm-2">
	...
	<form class="row g-3">
	  <div class="col-md-4">
	    ...
	    <textarea type="text" class="form-control" id="validationDefault01" value="Mark" required ></textarea> 
	  </div>

	  <div class="col-md-4">
	    <label for="validationDefault02" class="form-label">Past Patient Details</label>
	    <textarea type="text" class="form-control" id="validationDefault02" value="Otto" required></textarea>
	  </div>
    ...
    <div class ="input-field">
      <table class="table table-bordered" id ="table_field">
        ...
        <tr>
          ...
          <td> 
            <input type="button" class="btn btn-success btn-sm add" name="add" id="add" value="Add">
          </td> 
        </tr>
      </table>
    </div>
